            ...
            $(this).each(function () {
                ...
                if (!supportPlaceholder) {
                    ...
                    if (options.isUseSpan == false) {
                        ...
                        var $imitate = $('<span class="wrap-placeholder" style="position:absolute; display:inline-block; overflow:hidden; color:'+options.placeholderColor+'; ">' + defaultValue + '</span>');
                        $imitate.css({
                            'margin-left':$(_this).css('margin-left'),
                            'margin-top':'2px',
                            'font-size':$(_this).css('font-size'),
                            'font-weight':$(_this).css('font-weight'),
                            'padding-left':parseInt($(_this).css('padding-left')) + 10 + 'px',
                            'line-height':_this.nodeName.toLowerCase() == $(_this).outerHeight() + 'px',
                            'padding-top':_this.nodeName.toLowerCase() ==   '2px'
                        });
