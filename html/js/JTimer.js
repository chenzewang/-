...
var JTC = (function () {
    ...
    events = {
        ...
        showSelector: function (flag) {
            ...
            var _style = 'position:absolute; z-index:20010;    background-color: rgba(29, 47, 60, 0.6); width:78px; height:120px; top:' +
        ...
        yearSelector: function (table, start, rep) {
            ...
            cell.colSpan = 2;
            var bnStyle = 'border:0px;    background-color: rgba(29, 47, 60, 0.8);width:24px;height:20px; margin:0px 0px;';
    ...
    dialog = function () {
        this.getHeaderPanel = function () {
            ...
            var bnStyle = 'width:28px; height:21px; cursor: pointer; border: 0px none;    background-color: rgba(29, 47, 60, 0.8);            ;';
            var bn = util.createButton('<', bnStyle, function () { events.turnMonth(-1); }, 'bn_preMonth');
            cell.appendChild(bn);

            cell = row.insertCell(1);
            var style = 'cursor:pointer;width:54px; line-height:20px;    background-color: rgba(29, 47, 60, 0.8);';
        ...
        this.getWeekDayPanel = function () {
            var table = util.createTable();
            style = 'width:23px; height:20px; cursor:pointer; border-right:1px solid transpant; border-bottom:1px solid transpant; line-height:16px;';
            ...
            var style = 'height:23px; border-top:0px; border-bottom:1px solid #008FEE; border-right:0px; border-left:0px;    background-color: rgba(29, 47, 60, 0.8);            ';
            for (var i = 0; i < 7; i++) {
        ...
        this.getBottomPanel = function () {
            ...
            var bnStyle = 'font-size:12px;width:38px; border:0px;    background-color: rgba(29, 47, 60, 0.8);';
            cell = row.insertCell(1);
        ...
        _style = 'position:absolute; width:171px; height:190px;z-index:20000; font-size:12px;display:none;    background-color: rgba(29, 47, 60, 0.8);        ;';
        util.setObjectStyle(div, _style);
